<div class="row">
    <div class="col-md-12">
        <h3 class="text-center text-white bg-primary p-2">Sửa thông tin khóa học</h3>
        <hr>
    </div>
</div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select class="form-control" name="class" required>
                        <?php for ($i = 1; $i <= 10; $i++): ?>
                            <option value="<?php echo $i; ?>" <?php if (isset($course['class']) && $course['class'] == $i) echo 'selected'; ?>>
                                Lớp <?php echo $i; ?>
                            </option>
                        <?php endfor; ?>
                    </select>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="number" class="form-control" placeholder="Nhập học phí" name="fee" required
                           value="<?php echo htmlspecialchars($course['course_fee'] ?? '0'); ?>" />
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="date" class="form-control" name="date" required
                           value="<?php echo htmlspecialchars($course['course_start'] ?? date('Y-m-d')); ?>" />
                </div>
            </div>

            <div class="form-group row">
                <div class="offset-sm-2 col-sm-10">
                    <button class="btn btn-primary btn-block" type="submit">Cập nhật khóa học</button>
                </div>
            </div>
        </form>
    </div>
